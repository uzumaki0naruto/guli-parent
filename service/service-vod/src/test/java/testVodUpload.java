...
public class testVodUpload {
    public static void main(String[] args) {
        String accessKeyId = "LTAI5tR6VMTKnnnfUVkymoMj";
        String accessKeySecret = "xepSmhL5tdCtzkVE9QaqtC8Ux9y2YI";

        String title = "2021/11/2luZhi";   //上传之后文件名称
        String fileName = "D:video/2021.11.2.mp4";  //本地文件路径和名称
        //上传视频的方法
