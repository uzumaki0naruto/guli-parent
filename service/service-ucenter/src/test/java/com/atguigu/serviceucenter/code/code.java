package com.atguigu.serviceucenter.code;
...
//                代码生产到哪个目录
        gc.setOutputDir("E:\\guli-parent\\service\\service-ucenter"+"/src/main/java");
...
//        包的配置
        ...
        packageConfig.setModuleName("serviceucenter");//模块名
...
//        策略配置核心代码
        ...
        strategyConfig
                .setInclude("ucenter_member")    //设置需要生成的表
//                .setCapitalMode(true) //全局大写命名
//                .setDbColumnUnderline(true) // 指定表名和字段名是否使用了下划线
                .setEntityLombokModel(true)//自动生成lombok
                .setTablePrefix(packageConfig.getModuleName()+"")//生成实体时去掉表前缀
