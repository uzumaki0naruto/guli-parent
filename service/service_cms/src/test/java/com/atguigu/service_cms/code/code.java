package com.atguigu.service_cms.code;
...
//                代码生产到哪个目录
        gc.setOutputDir("E:\\guli-parent\\service\\service_cms"+"/src/main/java");
...
//        包的配置
        ...
        packageConfig.setParent("com.example.service_cms");
...
//        策略配置核心代码
        ...
        strategyConfig
                .setInclude("crm_banner")    //设置需要生成的表
