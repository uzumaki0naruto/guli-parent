...
//                代码生产到哪个目录
        gc.setOutputDir("E:\\guli-parent\\service\\service_comment"+"/src/main/java");//gai
...
//        包的配置
        ...
        packageConfig.setModuleName("com.atguigu.comment");//模块名
        packageConfig.setParent("");   //注意
...
//        策略配置核心代码
        ...
        strategyConfig
                .setInclude("edu_comment")    //设置需要生成的表
